...
<sub>Author: Sameer Khan | Date: 2026-03-18 | (C) Copyright: All Rights Reserved.</sub>
...
The rainbow colored image is a mathematical graph that accurately shows the inner workings of how (in this instance) the AI model called "Gemini 3.1" tries to learn new concepts. 
...
On 16-03-2026, I finally managed to achieve a breakthrough in my work spanning 18 years of research and development (R&D) in topics pertaining to cognitive science, machine learning, and Artificial Intelligence, since the year Jan-2008. This article is an introduction to how I was able to create a method for probing and visualizing the internal process of a given AI model as it finds systematic relationships between different concepts, when it learns and adapts to new ones. A methodology to analyze and evaluate the AI's "rationality", so to speak. 
